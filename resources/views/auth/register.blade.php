...
<form method="POST" action="{{ route('register') }}" class="w-full max-w-sm mx-auto rounded-lg border shadow-md p-5 mb-5">
    ...
    <div class="mb-4">
        ...
        <input id="name" type="text" name="name" class="shadow border rounded-full p-2 w-full" value="{{ old('name') }}" autocomplete="name" placeholder="Nom d'utilisateur" autofocus>
        @error('name')
    ...
    <div class="mb-4">
        ...
        <input id="password" type="password" name="password" class="shadow border rounded w-full p-2" value="{{ old('password') }}" autocomplete="new-password" placeholder="Votre mot de passe" autofocus>
        @error('password')
            <span class="text-red-400 text-sm">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="mb-4">
        ...
        <input id="password_confirmation" type="password" name="password_confirmation" class="shadow border rounded w-full p-2" value="{{ old('password_confirmation') }}" autocomplete="new-password" placeholder="Retapez votre mot de passe" autofocus>
    </div>
    ...
    <button type="submit" class="bg-green-500 text-white hover:bg-green-700 transition ease-in-out duration-500 rounded-md shadow-md w-full px-4 py-2">Créer mon compte</button>
</form>
